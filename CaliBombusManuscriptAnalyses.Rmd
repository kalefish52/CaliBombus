...
#Does not go into final paper 
```{r, echo=FALSE}
# Shannon's Diversity for Ecoregion level and Site Level 
##Site Level 
Shannonmatrix<-AllSpp %>% select(!c(Date_comb, SpeciesRichness, TotalAbundance, Ecoregion.1, Site_Grouping, coords.x1, coords.x2, Ecoregion))
