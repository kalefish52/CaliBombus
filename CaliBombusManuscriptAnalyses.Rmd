...
NMDSplot<-ggplot() + 
  ...
  geom_text(data=species.scores, aes(x=NMDS1, y=NMDS2, label=species), size=2.5, position=position_jitter(width=3, height=4))+
  scale_x_continuous(limits = c(-3.5, 3.5)) +
  theme_bw()+scale_y_continuous(limits=c(-3.5,3.5)) 
