...
TotalBreakdown
ungroup(TotalBreakdown$Verified.Bee.species.ID)
commatrix<-TotalBreakdown %>% select(!c(TotalAbundance, SpeciesRichness, Date_comb, Ecoregion.1, EcoregionNum, coords.x.1, coords.x2)) %>% unique()
commatrix
