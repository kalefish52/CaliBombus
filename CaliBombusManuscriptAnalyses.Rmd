...
## Make a dataframe - alpha, with diversity, abundance and richness for each site
```{r}
...
DataMetrics %>% select(Site, FloralAssociation, Ecoregion) %>% unique()


# Transform dataframe for diversity metrics 
DataMatrix<-
