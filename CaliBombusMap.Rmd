...
tm_shape(s.sf.eco) + tm_polygons(col="US_L3NAME", border.col="white", palette="Pastel1", title="Ecoregion")+ tm_legend(outside = TRUE)+tm_shape(site.sf) + tm_dots(size=0.05, col="black") + tm_text("Site_Grouping", just = "left", size = 0.5)
